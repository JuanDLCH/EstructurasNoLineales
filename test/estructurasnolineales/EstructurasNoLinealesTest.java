...
public class EstructurasNoLinealesTest {
    ...
    public void testLastLevel() {
        ...
        testDeleteOneByOne(); //Profe, "tener en cuenta que se han eliminado nodos del árbol de pruebas" , faltaba llamar este método.
        assertEquals(3, /*test.CountNodes*/ test.LastLevel()); 
        //Aquí estaba test.CountNodes(), lo cambié por test.LastLevel(), que es el método
        //Con el cuál se debería comprobar
    }
    ...
    public void testLevelOrder() {
        ...
        System.out.flush();
        //llamar al método
        testDeleteOneByOne(); //Para el resultado pedido hay que hacer este delete primero
        test.LevelOrder();
        //validar la salida
        assertEquals("10 \n7 21 \n18 23 \n24 ", /*salida.toString*/ test.LevelOrder()); 
        //Cambié la comparación, mi método devuelve el resultado como cadena de texto
        //Así que ya no es necesario que compare con la salida.
    }
